...
export const authService = {
  register: (name, email, phoneNo, password, role, adminSecret) =>
    api.post('/auth/register', { name, email, phoneNo, password, role, adminSecret }).then(res => res),
  ...
  changePassword: (currentPassword, newPassword, confirmPassword) => 
    api.put('/auth/password', { currentPassword, newPassword, confirmPassword }).then(res => res),
};
...
export const adminService = {
  ...
  banUser: (userId, reason) => api.put(`/admin/users/${userId}/ban`, { reason }).then(res => res),
  unbanUser: (userId) => api.put(`/admin/users/${userId}/unban`).then(res => res),
