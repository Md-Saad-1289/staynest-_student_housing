 ...
 */
export const StudentDashboardModernPage = () => {
    ...
    <DashboardLayout title="My Dashboard">
      ...
      <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-sm text-blue-900 font-medium flex items-center gap-2">
          ...
          <strong>Student Privileges:</strong> You can view your bookings and write reviews after stays complete. You cannot manage listings or verify owners.
        </p>
      </div>
    </DashboardLayout>
  );
