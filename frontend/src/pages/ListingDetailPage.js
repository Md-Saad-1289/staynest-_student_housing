...
const DESIGN_STYLES = `
  ...
  /* Hero */
  .ldp-hero { position: relative; width: 100%; height: 520px; overflow: hidden; }
  @media (max-width: 768px) { .ldp-hero { height: 320px; } }
  .ldp-hero img { width: 100%; height: 100%; object-fit: cover; transition: transform 8s ease; }
  .ldp-hero:hover img { transform: scale(1.04); }
  .ldp-hero-overlay {
    position: absolute; inset: 0;
    background: linear-gradient(to top, rgba(13,13,13,0.82) 0%, rgba(13,13,13,0.3) 50%, transparent 100%);
  }
  .ldp-hero-content { position: absolute; bottom: 0; left: 0; right: 0; padding: 2.5rem 3rem; }
  @media (max-width: 768px) { .ldp-hero-content { padding: 1.5rem; } }
  ...
  .ldp-badge-verified {
    ...
    font-size: 12px; font-weight: 600; letter-spacing: 0.04em; backdrop-filter: blur(8px);
    margin-bottom: 12px;
  }
    ...
    <>
      ...
      <div className="ldp-root" style={{ minHeight: '100vh', paddingBottom: 80 }}>
        ...
        <div className="ldp-hero">
          ...
          <div className="ldp-hero-overlay" />
          <div className="ldp-hero-content">
            {L.verified && <div className="ldp-badge-verified">✦ Verified Listing</div>}
            <h1 className="ldp-serif" style={{ fontSize: 'clamp(24px, 4vw, 42px)', color: 'white', margin: '0 0 8px', lineHeight: 1.2, fontStyle: 'italic' }}>
              {L.title}
            </h1>
            <p style={{ color: 'rgba(255,255,255,0.65)', fontSize: 15, margin: 0, letterSpacing: '0.03em' }}>
              📍 {L.area}, {L.city}
            </p>
          </div>
        </div>
        ...
        {/* ── Stat ribbon ── */}
        <div className="ldp-container" style={{ marginTop: '-24px', position: 'relative', zIndex: 2 }}>
        ...
        <div className="ldp-container">
          <div className="ldp-grid">
            ...
            <div>
              ...
              {/* Mobile image slider */}
              <div style={{ display: 'none' }} className="mobile-slider">
              ...
              <div className="ldp-section">
                ...
                <AvailabilityCalendar listingId={L._id} bookings={bookings} />
                <p className="ldp-description" style={{ marginTop: 16 }}>{L.description}</p>
                {L.rules && (
